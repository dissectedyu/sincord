...
The Sincord Installer allows you to install [Sincord, the cutest Discord Desktop client mod](https://github.com/Sincord/Sincord)
...
See [the GitHub workflow](https://github.com/Sincord/Sinlotl/blob/main/.github/workflows/release.yml) for what flags I pass or if you want more precise instructions
